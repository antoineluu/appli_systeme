...
Xtrain, catrain, crtrain = readsamples(fileTrain, keys=keys, nsamples=[1000], groups=[25], mode=modeTrain, parts=None, seed=seed)
Xvalid, cavalid, crvalid = readsamples(fileValid, keys=keys, nsamples=[400], groups=[25], mode=modeValid, parts=None, seed=seed)
Xtest, catest, crtest = readsamples(fileTest, keys=keys, nsamples=[400], groups=[25], mode=modeTest, parts=None, seed=seed)
